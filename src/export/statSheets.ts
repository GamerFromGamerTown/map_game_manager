...
export const renderVerbatimCountryStatSheet = (
  ...
  const lines = [
    ...
    `**Necessities:** ${formatNumber(countryPreview.necessitiesProduced)}/${formatNumber(countryPreview.necessitiesRequired)} (1 needed per ${formatNumber(state.rules.settings.necessities_manpower_cap_divisor)} manpower cap)`,
    "",
...
export const renderPolishedCountryStatSheet = (
  ...
  return [
    ...
    `**Necessities:** ${formatNumber(countryPreview.necessitiesProduced)}/${formatNumber(countryPreview.necessitiesRequired)} (${countryPreview.necessitiesMet ? "met" : "not met"})`,
    "",
    "## Gold breakdown",
    "",
